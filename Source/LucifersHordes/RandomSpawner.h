...
UCLASS()
class LUCIFERSHORDES_API ARandomSpawner : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere)
		TArray<FName> TRooms;
	UPROPERTY(EditAnywhere)
		TArray<FName> EndRooms;
	UPROPERTY(EditAnywhere)
		TArray<FName> TurnRooms;
	UPROPERTY(EditAnywhere)
		TArray<FName> StraightRooms;
	UPROPERTY(EditAnywhere)
		TArray<FName> CrossRooms;
